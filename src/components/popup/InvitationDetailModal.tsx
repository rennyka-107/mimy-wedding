                        ...
                        <div className="p-8 overflow-y-auto max-h-[90vh]">
                            ...
                            <div className="flex items-start gap-6 mb-8">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="text-lg font-semibold text-[#CE6F70] mb-4">
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-center text-gray-600">
                                            <svg className="w-5 h-5 mr-3 text-[#CE6F70]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                                            </svg>
                                            Đường dẫn:&nbsp;<span className="text-[#CE6F70] font-bold cursor-pointer" onClick={() => window.open(invitation.url, '_blank')}>{invitation.url}</span>
                                        </div>
                                        <div className="flex items-center text-gray-600">
                                            <svg className="w-5 h-5 mr-3 text-[#CE6F70]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
