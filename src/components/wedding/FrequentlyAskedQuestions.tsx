...
export default function FrequentlyAskedQuestions() {
    ...
    return (
        <motion.div 
            ...
            className="w-full py-[96px] px-5 xl:px-48 lg:px-24 md:px-20 sm:px-10"
        >
            ...
            <motion.p 
                ...
                viewport={{ once: true }}
                className="font-montserrat flex justify-center text-center items-center gap-2 lg:text-[18px] md:text-[16px] sm:text-[14px] text-[14px] text-[#898A85] mt-5 px-8"
            >
