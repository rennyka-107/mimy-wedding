            ...
            <div className="flex items-center ml-4 gap-[8px] relative">
             ...
             hover:opacity-90 transition-opacity"
                ...
                <>
                  ...
                  >
                    <svg className="max-h-[24px] max-w-[24px]" width="full" height="full" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="hidden lg:block ml-2 font-[600]">Đăng nhập bằng Email</span>
                  </Button>
                </>
              )}
            </div>
