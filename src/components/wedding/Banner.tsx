...
export default function Banner() {
    ...
    return (
        <div
            ...
            <svg className="hidden md:block sm:h-[700px] sm:w-[2000px] md:w-full md:h-full  top-0" width="0" height="0" viewBox="0 0 2000 700" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="md:hidden block sm:h-full xs:w-full top-0" width="full" height="850" viewBox="0 0 700 700" fill="none" xmlns="http://www.w3.org/2000/svg">
