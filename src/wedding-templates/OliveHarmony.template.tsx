...
export default function OliveHarmonyTemplate() {
  ...
  return (
    <div className="relative font-nunito">
      <img onClick={(e) => {
            e.stopPropagation();
            setSelectedComponent('left', 'image', images['left'])
          }} src={images['left'] ? images['left'].url : '/images/logo.png'} alt="Hero" className="absolute top-[200px] left-0 object-cover" />
      <img onClick={(e) => {
            e.stopPropagation();
            setSelectedComponent('right', 'image', images['right'])
      ...
      <div className="w-full pt-[75px]">
        ...
        }} className="font-[700] text-center mt-[1rem] leading-[2] tracking-[0%]" style={{ color: texts['text_1'].text_color, fontSize: texts['text_1'].text_size }}>{texts['text_1'] && texts['text_1'].content}</div>
        <div onClick={(e) => {
          e.stopPropagation();
          setSelectedComponent('text_2', 'text', texts['text_2'])
        }} className="font-[700] text-center leading-0 tracking-[0%]" style={{ color: texts['text_2'].text_color, fontSize: texts['text_2'].text_size }}>{texts['text_2'] && texts['text_2'].content}</div>
        <div onClick={(e) => {
          e.stopPropagation();
        ...
        <div className="px-[48px] flex justify-between mt-[2rem]">
          ...
          <div className="flex flex-col gap-[4px] items-end flex-1">
            ...
            }} style={{ color: texts['text_9'].text_color, fontSize: texts['text_9'].text_size }}>{texts['text_9'].content}</div>
          </div>
        </div>
        <div onClick={(e) => {
          e.stopPropagation();
          setSelectedComponent('text_10', 'text', texts['text_10'])
        }} style={{ marginTop: '2rem', textAlign: 'center', fontWeight: 700, color: texts['text_10'].text_color, fontSize: texts['text_10'].text_size }}>{texts['text_10'].content}</div>
        <div onClick={(e) => {
          e.stopPropagation();
          setSelectedComponent('text_11', 'text', texts['text_11'])
        }} style={{ padding: '0 48px', textAlign: 'center', fontWeight: 500, color: texts['text_11'].text_color, fontSize: texts['text_11'].text_size }}>{texts['text_11'].content}</div>
        <div onClick={(e) => {
          e.stopPropagation();
          setSelectedComponent('text_12', 'text', texts['text_12'])
        }} style={{ fontFamily: 'WindSong', padding: '0 48px', marginTop: "12px", textAlign: 'center', fontWeight: 500, color: texts['text_12'].text_color, fontSize: texts['text_12'].text_size }}>{texts['text_12'].content}</div>
        <div onClick={(e) => {
          e.stopPropagation();
          setSelectedComponent('text_13', 'text', texts['text_13'])
        }} style={{ fontFamily: 'WindSong', padding: '0 48px', textAlign: 'center', fontWeight: 500, color: texts['text_13'].text_color, fontSize: texts['text_13'].text_size }}>{texts['text_13'].content}</div>
        <div onClick={(e) => {
          e.stopPropagation();
          setSelectedComponent('text_14', 'text', texts['text_14'])
        }} style={{ fontFamily: 'WindSong', padding: '0 48px', textAlign: 'center', fontWeight: 500, color: texts['text_14'].text_color, fontSize: texts['text_14'].text_size }}>{texts['text_14'].content}</div>
        <div onClick={(e) => {
          e.stopPropagation();
          setSelectedComponent('text_15', 'text', texts['text_15'])
        }} style={{ padding: '0 48px', marginTop: "42px", textAlign: 'center', fontWeight: 500, color: texts['text_15'].text_color, fontSize: texts['text_15'].text_size }}>{texts['text_15'].content}</div>
        <div onClick={(e) => {
          e.stopPropagation();
          setSelectedComponent('text_16', 'text', texts['text_16'])
        }} style={{ padding: '0 48px', textAlign: 'center', fontWeight: 500, color: texts['text_16'].text_color, fontSize: texts['text_16'].text_size }}>{texts['text_16'].content}</div>
        <div onClick={(e) => {
          e.stopPropagation();
          setSelectedComponent('text_17', 'text', texts['text_17'])
        }} style={{ padding: '0 48px', marginTop: "22px", textAlign: 'center', fontWeight: 500, color: texts['text_17'].text_color, fontSize: texts['text_17'].text_size }}>{texts['text_17'].content}</div>
        <div onClick={(e) => {
          e.stopPropagation();
          setSelectedComponent('text_18', 'text', texts['text_18'])
        }} style={{ padding: '0 48px', textAlign: 'center', fontWeight: 500, color: texts['text_18'].text_color, fontSize: texts['text_18'].text_size }}>{texts['text_18'].content}</div>
        <div onClick={(e) => {
          e.stopPropagation();
          setSelectedComponent('text_19', 'text', texts['text_19'])
        }} style={{ padding: '0 48px', textAlign: 'center', fontWeight: 500, color: texts['text_19'].text_color, fontSize: texts['text_19'].text_size }}>{texts['text_19'].content}</div>
        <div onClick={(e) => {
          e.stopPropagation();
          setSelectedComponent('text_20', 'text', texts['text_20'])
        }} style={{ padding: '0 48px', marginTop: "24px", textAlign: 'center', fontWeight: 500, color: texts['text_20'].text_color, fontSize: texts['text_20'].text_size }}>{texts['text_20'].content}</div>
        ...
        }} style={{ padding: '0 48px', marginTop: "24px", textAlign: 'center', fontWeight: 500, color: texts['text_21'].text_color, fontSize: texts['text_21'].text_size }}>{texts['text_21'].content}</div>
        ...
        }} style={{ padding: '0 48px', marginTop: "24px", textAlign: 'left', fontWeight: 700, color: texts['text_22'].text_color, fontSize: texts['text_22'].text_size }}>{texts['text_22'].content}</div>
        <div className="px-[48px]">
          <div onClick={(e) => {
            e.stopPropagation();
            setSelectedComponent('text_23', 'text', texts['text_23'])
          }} className="flex items-center gap-[1rem] py-[12px]" style={{ borderStyle: 'dashed', borderBottomWidth: '1px', borderColor: '#8BB087' }}>
          ...
          <div onClick={(e) => {
            ...
            <div className="flex flex-col">
              <div onClick={(e) => {
                e.stopPropagation();
                setSelectedComponent('text_27', 'text', texts['text_27'])
              }} style={{ textAlign: 'left', fontWeight: 500, color: texts['text_27'].text_color, fontSize: texts['text_27'].text_size }}>{texts['text_27'].content}</div>
              <div onClick={(e) => {
                e.stopPropagation();
                setSelectedComponent('text_28', 'text', texts['text_28'])
              }} style={{ textAlign: 'left', fontWeight: 700, color: texts['text_28'].text_color, fontSize: texts['text_28'].text_size }}>{texts['text_28'].content}</div>
            </div>
          </div>
        </div>
        <div className="px-[48px] py-[36px] mt-[32px]">
          <div className="flex justify-between items-center">
            <div className="flex flex-col">
              ...
              }} style={{fontFamily: "WindSong", textAlign: 'left', lineHeight: '1', fontWeight: 400, color: texts['text_37'].text_color, fontSize: texts['text_37'].text_size }}>
                {texts['text_37'].content}
              </div>
              <div onClick={(e) => {
                e.stopPropagation();
                setSelectedComponent('send_gift_1', 'send_gift', send_gifts['send_gift_1'])
              }} style={{ marginTop: "1rem", textAlign: 'left', lineHeight: '1', fontWeight: 500, color: send_gifts['send_gift_1'].text_bank_color, fontSize: send_gifts['send_gift_1'].text_bank_size }}>
                {send_gifts['send_gift_1'].bank_name}
              </div>
              <div onClick={(e) => {
                e.stopPropagation();
                setSelectedComponent('send_gift_1', 'send_gift', send_gifts['send_gift_1'])
              }} style={{ marginTop: "0.2rem", textAlign: 'left', lineHeight: '1', fontWeight: 500, color: send_gifts['send_gift_1'].text_bank_color, fontSize: send_gifts['send_gift_1'].text_bank_size }}>
            ...
            <div>
              <div className="flex flex-col items-center gap-[10px]">
                ...
                <div className="w-[max-content] px-[20px] py-[4px] text-center rounded-[24px]" style={{ backgroundColor: send_gifts['send_gift_1'].background_color, textAlign: 'center', fontWeight: 700, color: send_gifts['send_gift_1'].text_color, fontSize: send_gifts['send_gift_1'].text_size }}>{send_gifts['send_gift_1'].content}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        }} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '200px', background: `url(${images['image_5'].url}) 100% 100%`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
            <div style={{ padding: '0 48px', textAlign: 'left', lineHeight: '1', fontWeight: 400, color: texts['text_38'].text_color, fontSize: texts['text_38'].text_size }}>
