...
export default function JadeWhisperTemplate({isPublicPage = false}: {isPublicPage: boolean}) {
    ...
    useEffect(() => {
        if (!isPublicPage) updateTemplate(templateForestCharm)
    }, [isPublicPage])
    ...
    return (
        <div className={`relative ${!images['image_1'].isDeleted ? 'pt-[36rem]' : ''} font-plus-jakarta-sans bg-white`}>
            {!images['image_1'].isDeleted && <svg className="absolute top-0 z-2 left-1/2 -translate-x-1/2" width="461" height="66" viewBox="0 0 461 66" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {!images['image_1'].isDeleted && <div className="absolute top-[-10px] z-0 left-1/2 -translate-x-1/2">
            ...
            {countdownConfig && !countdownConfig?.isDeleted && <div className="cursor-pointer px-[32px] pb-[30px]" onClick={(e) => {
                e.stopPropagation();
            ...
            <div className="mt-[24px] px-[20px] pb-[30px] text-center">
                ...
                <div className="mt-[8px] flex justify-center items-center gap-[10px]">
                    ...
                    {!background_colors['bg_color_4'].isDeleted && <div onClick={(e) => {
                        e.stopPropagation();
            ...
            <div className="w-full px-[32px]">
                {!images['image_2'].isDeleted && <img onClick={(e) => {
                    e.stopPropagation();
            ...
            <div className="px-[32px] py-[30px]">
                ...
                {!images['image_3'].isDeleted && <img onClick={(e) => {
                    e.stopPropagation();
            ...
            <div className="px-[32px] pb-[30px]">
                ...
                {!texts['text_21'].isDeleted && <div onClick={(e) => {
                    e.stopPropagation();
                ...
                {!images['image_4'].isDeleted && <img onClick={(e) => {
                    e.stopPropagation();
            ...
            <div className="w-[80%] mx-auto mt-[2rem] pb-[1rem] relative">
                {!background_colors['bg_color_6'].isDeleted && <svg onClick={(e) => {
                    e.stopPropagation();
                ...
                {background_colors['bg_color_7'] && !background_colors['bg_color_7'].isDeleted && <svg onClick={(e) => {
                    e.stopPropagation();
                ...
                {!texts['text_22'].isDeleted && <div onClick={(e) => {
                    e.stopPropagation();
                ...
                {!texts['text_23'].isDeleted && <div onClick={(e) => {
                    e.stopPropagation();
                ...
                {!send_gifts['send_gift_1'].isDeleted && <div className="flex flex-col mt-[1rem]">
                    <div onClick={(e) => {
                        e.stopPropagation();
