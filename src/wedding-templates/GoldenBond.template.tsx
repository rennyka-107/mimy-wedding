...
export default function GoldenBondTemplate({isPublicPage = false}: {isPublicPage: boolean}) {
  ...
  useEffect(() => {
    if (!isPublicPage) updateTemplate(templateGoldenBond)
  }, [isPublicPage])
  return (
    <div className="relative font-nunito">
      <div className="mx-[16px] my-[16px] relative cursor-pointer">
        {images['image_1'] && !images['image_1'].isDeleted && <img onClick={(e) => {
          e.stopPropagation();
        ...
        {images['image_1'] && !images['image_1'].isDeleted && <div onClick={(e) => {
          e.stopPropagation();
          setSelectedComponent('image_1', 'image', images['image_1'])
      ...
      <div className="m-[1rem] flex justify-between">
        {images['image_2'] && !images['image_2'].isDeleted && <div className="w-[90px] h-[90px]">
          <img onClick={(e) => {
            e.stopPropagation();
        ...
        {images['image_3'] && !images['image_3'].isDeleted && <div className="w-[90px] h-[90px]">
          <img onClick={(e) => {
            e.stopPropagation();
        ...
        {images['image_4'] && !images['image_4'].isDeleted && <div className="w-[90px] h-[90px]">
          <img onClick={(e) => {
            e.stopPropagation();
        ...
        {images['image_5'] && !images['image_5'].isDeleted && <div className="w-[90px] h-[90px]">
          <img onClick={(e) => {
            e.stopPropagation();
      ...
      <div className="w-full pt-[2rem] pb-[1rem] relative flex flex-col items-center mt-[5rem] gap-[2rem]">
        ...
        <div className="flex flex-col items-center gap-[1rem]">
          <div onClick={(e) => {
          ...
          }} style={{ cursor: 'pointer', display: "flex", alignItems: 'center', gap: '8px', background: background_colors['bg_color_1'].isDeleted ? 'none' : background_colors['bg_color_1'].color, borderRadius: '8px', padding: '8px 16px', textAlign: 'center', fontStyle: 'medium', fontWeight: 500, color: texts['text_9'].text_color, fontSize: texts['text_9'].text_size }}>
            ...
            {texts['text_9'] && !texts['text_9'].isDeleted && <span onClick={(e) => {
              e.stopPropagation();
        ...
        <div className="mt-[2rem] flex flex-col items-center gap-[1rem]">
          <div onClick={(e) => {
          ...
          }} style={{ cursor: 'pointer', display: "flex", alignItems: 'center', gap: '8px', background: background_colors['bg_color_2'].isDeleted ? 'none' : background_colors['bg_color_2'].color, borderRadius: '8px', padding: '8px 16px', textAlign: 'center', fontStyle: 'medium', fontWeight: 500, color: texts['text_12'].text_color, fontSize: texts['text_12'].text_size }}>
            ...
            {texts['text_12'] && !texts['text_12'].isDeleted && <span onClick={(e) => {
              e.stopPropagation();
        ...
        <div onClick={(e) => {
          ...
          {texts['text_15'] && !texts['text_15'].isDeleted ? texts['text_15'].content : ''}
          <div className="mt-[8px] flex justify-center items-center gap-[10px]">
            ...
            }} style={{ cursor: 'pointer', width: '30px', height: '30px', borderRadius: '50%', backgroundColor: background_colors['bg_color_3'].isDeleted ? 'none' : background_colors['bg_color_3'].color, border: background_colors['bg_color_3'].border_color === 'none' ? 'none' : `1px solid ${background_colors['bg_color_3'].border_color}` }} />
            <div onClick={(e) => {
              e.stopPropagation();
              setSelectedComponent('bg_color_4', 'background_color', background_colors['bg_color_4'])
            }} style={{ cursor: 'pointer', width: '30px', height: '30px', borderRadius: '50%', backgroundColor: background_colors['bg_color_4'].isDeleted ? 'none' : background_colors['bg_color_4'].color, border: background_colors['bg_color_4'].border_color === 'none' ? 'none' : `1px solid ${background_colors['bg_color_4'].border_color}` }} />
            <div onClick={(e) => {
              e.stopPropagation();
              setSelectedComponent('bg_color_5', 'background_color', background_colors['bg_color_5'])
            }} style={{ cursor: 'pointer', width: '30px', height: '30px', borderRadius: '50%', backgroundColor: background_colors['bg_color_5'].isDeleted ? 'none' : background_colors['bg_color_5'].color, border: background_colors['bg_color_5'].border_color === 'none' ? 'none' : `1px solid ${background_colors['bg_color_5'].border_color}` }} />
          </div>
        </div>
      </div>
      ...
      }} className="cursor-pointer relative w-[80%] mx-auto p-[40px]" style={{ borderRadius: "24px", background: background_colors['bg_color_6'].isDeleted ? 'none' : background_colors['bg_color_6'].color }}>
      ...
      <div className="w-[80%] mx-auto mt-[5rem]">
        {texts['text_33'] && !texts['text_33'].isDeleted && <div onClick={(e) => {
          e.stopPropagation();
        ...
        {texts['text_34'] && !texts['text_34'].isDeleted && <div onClick={(e) => {
          e.stopPropagation();
        ...
        {images['image_qr'] && !images['image_qr'].isDeleted && <img onClick={(e) => {
          e.stopPropagation();
        ...
        {send_gifts['send_gift_1'] && !send_gifts['send_gift_1'].isDeleted && <div className="flex flex-col mt-[1rem]">
          <div onClick={(e) => {
            e.stopPropagation();
      ...
      <div onClick={(e) => {
      ...
      }} style={{ cursor: 'pointer', marginTop: '1rem', position: 'relative', padding: '0 54px', flexDirection: "column", display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '250px', background: images['image_6'].isDeleted ? 'none' : `url(${images['image_6'].url}) 100% 100%`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
        <div onClick={(e) => {
          e.stopPropagation();
          setSelectedComponent('image_6', 'image', images['image_6'])
        }} className="bg-black" style={{ position: 'absolute', width: '100%', height: '100%', opacity: 0.5 }} />
        {texts['text_35'] && !texts['text_35'].isDeleted && <div onClick={(e) => {
          e.stopPropagation();
        ...
        {texts['text_36'] && !texts['text_36'].isDeleted && <div onClick={(e) => {
          e.stopPropagation();
