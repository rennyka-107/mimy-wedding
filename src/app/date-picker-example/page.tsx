          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#fd8c06]"
              ...
              <button 
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 hover:text-[#fd8c06]"
              >
