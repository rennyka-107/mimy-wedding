  ...
  return (
    <div className="w-full bg-[#FFFFFF] px-[15%] py-[50px]">
      <div>
        ...
        <div className="flex justify-between pt-6 mx-[50px]">
          <div className="flex">
            <div className="flex justify-center items-center px-4 p-2 bg-[#f9f9f9] rounded-[4px] text-[14px] mr-2 h-fit">
              <span className="pr-2">Lọc theo giá</span>
              <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 4.5L6 7.5L3 4.5" stroke="#383637" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </div>
            <div className="flex justify-center items-center px-4 p-2 bg-[#f9f9f9] rounded-[4px] text-[14px] mr-2 h-fit">
              <span className="pr-2">Lọc theo màu</span>
              <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 4.5L6 7.5L3 4.5" stroke="#383637" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </div>
          </div>
          <div className="flex justify-start items-center px-4 p-2 bg-[#f9f9f9] rounded-[4px] text-[14px] lg:w-[400px] w-full h-fit">
            <svg className="mr-2" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8.25 14.25C11.5637 14.25 14.25 11.5637 14.25 8.25C14.25 4.93629 11.5637 2.25 8.25 2.25C4.93629 2.25 2.25 4.93629 2.25 8.25C2.25 11.5637 4.93629 14.25 8.25 14.25Z" stroke="#383637" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M15.75 15.7498L12.4875 12.4873" stroke="#383637" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <span>Tìm kiếm theo tên thiệp</span>
          </div>
        </div>
      </div>
